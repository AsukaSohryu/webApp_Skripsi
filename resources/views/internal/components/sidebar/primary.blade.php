        ...
        <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-6" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item {{ $pageTitle == 'Dashboard' ? 'here' : '' }} show py-2">
                ...
                <div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    @include('internal.components.sidebar.menu-item.home')
            ...
            {{-- <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
                ...
                <div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    @include('internal.components.sidebar.menu-item.apps')
                    <!--end:Menu item-->
                </div>
                <!--end:Menu sub-->
            </div> --}}
    ...
    <div class="d-flex flex-column flex-center pb-4 pb-lg-8" id="kt_app_sidebar_footer">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">RPA Admin</a>
                    </div>
                    <!--end::Username-->
                </div>
            </div>
            ...
            {{-- <div class="menu-item px-5">
                <a href="../../demo24/dist/account/overview.html" class="menu-link px-5">My Profile</a>
            </div> --}}
            <!--end::Menu item-->

            <!--begin::Menu item-->
            {{-- <div class="menu-item px-5">
                <a href="../../demo24/dist/apps/projects/list.html" class="menu-link px-5">
            ...
            {{-- <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-end" data-kt-menu-offset="-15px, 0">
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/referrals.html" class="menu-link px-5">Referrals</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/billing.html" class="menu-link px-5">Billing</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/statements.html" class="menu-link px-5">Payments</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">Statements
            ...
            {{-- <div class="menu-item px-5">
                <a href="../../demo24/dist/account/statements.html" class="menu-link px-5">My Statements</a>
            </div> --}}
            ...
            {{-- <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="0, 0">
                <a href="#" class="menu-link px-5">
                    ...
                    <img class="w-15px h-15px rounded-1 ms-2" src="assets/internal/media/flags/united-states.svg" alt="" /></span></span>
                </a>
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/settings.html" class="menu-link d-flex px-5 active">
                        <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="assets/internal/media/flags/united-states.svg" alt="" />
                        </span>English</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="../../demo24/dist/account/settings.html" class="menu-link d-flex px-5">
                        <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="assets/internal/media/flags/spain.svg" alt="" />
                        </span>Indonesia</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            {{-- <div class="menu-item px-5 my-1">
                <a href="../../demo24/dist/account/settings.html" class="menu-link px-5">Account Settings</a>
            </div> --}}
            <!--end::Menu item-->

            <div class="menu-item px-5">
                <a class="menu-link px-5" data-bs-toggle="modal" data-bs-target="#modal_logout">Sign Out</a>
            </div>
        </div>
    </div>
</div>
