				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="../../demo24/dist/authentication/layouts/overlay/sign-in.html" action="#">
								<!--begin::Heading-->
								...
								<div class="fv-row mb-8">
									<!--begin::name-->
									<input type="text" placeholder="Nama" name="email" autocomplete="off" class="form-control bg-transparent" />
									<!--end::name-->
								</div>
								<!--begin::Input group-->
								...
								<a href="../../demo24/dist/authentication/layouts/overlay/sign-in.html" class="link-primary fw-semibold">Masuk</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
