        ...
        <form action="{{ route('informasiShelter.edit.post') }}" method="post" enctype="multipart/form-data" id="formShelter">
            ...
            <div class="row my-3">
                <div class="col my-3 d-flex flex-column justify-content-center">
                    <label for="" class="mb-2">Unggah Logo Shelter</label>
            ...
            <div class="row my-3">
                <div class="col">
                    <label for="" class="mb-2">Nama Shelter</label>
            ...
            <div class="row my-3">
                <div class="col my-3 d-flex flex-column justify-content-center">
                    <label for="" class="mb-2">Upload Foto Shelter</label>
            ...
            <div class="row my-3">
                <div class="col">
                    <label for="" class="mb-2">Informasi Formulir Laporan Penemuan Hewan Liar</label>
                    <textarea name="reportInfo" id="summernote1" class="form-control" rows="4">{{$shelterInformation->report_information}}</textarea>
                </div>
            </div>
            <div class="row my-3">
                <div class="col">
                    <label for="" class="mb-2">Informasi Formulir Pengajuan Penyerahan Hewan</label>
                ...
                <div class="d-flex flex-row justify-content-between p-3" style="background-color: #CADFF2; border-radius: .475rem;">
                    ...
                    <div class="col d-flex align-items-center justify-content-end">
                        ...
                        @if($shelterInformation->is_accepting_report == 1)
                            <label for="" class="mb-2 ps-3"><b>Aktif</b></label>
                        @else
                            <label for="" class="mb-2 ps-3"><b>Tidak Aktif</b></label>
                        @endif
                    </div>
                </div>
            </div>
